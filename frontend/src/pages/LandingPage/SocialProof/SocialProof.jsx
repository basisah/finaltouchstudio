...
import { SOCIAL_POSTS } from "../../../constants/categories";
...
const PLATFORM_META = {
  ...
  tiktok:    { Icon: TkIcon, color: "#010101", label: "TikTok"    },
  pinterest: { Icon: PtIcon, color: "#E60023", label: "Pinterest"  },
};

// Override SOCIAL_POSTS platforms for demo
const DEMO_POSTS = [
...
export default function SocialProof() {
  ...
  return (
    <section className={styles.section} aria-label="Social media proof">
      <div className={styles.inner}>
        <div className={styles.header}>
          <div>
            <p className={styles.eyebrow}>Follow Our Journey</p>
            <h2 className={styles.heading}>Loved on Social Media</h2>
          </div>
